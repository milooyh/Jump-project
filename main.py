...
class ChasingEnemy:
    ...
    def draw(self, screen):
        pygame.draw.polygon(screen, BLACK, [(self.x + enemy_width//2, self.y),
                                            (self.x + enemy_width, self.y + enemy_height//2),
                                            (self.x + enemy_width//2, self.y + enemy_height),
                                            (self.x, self.y + enemy_height//2)])
